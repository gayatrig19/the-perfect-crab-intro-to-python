...
# The `if` keyword looks at whether the conditional expression
# evaluates to True or False to decide whether to execute its block,
# or the else block.
...
# Note that this operator only takes one value. The operator goes first,
...
# Perhaps you could have guessed those... but now you know for sure!
